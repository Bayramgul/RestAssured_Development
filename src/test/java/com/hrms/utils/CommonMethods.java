...
public class CommonMethods extends PageInitializeAll {
	private static Logger log = LoggerFactory.getLogger(CommonMethods.class);
	/**
	  ...
	  public static void selectDateFromTable (WebElement table , String day) {
	   ...
	   /**
	     ...
	     public static void testingSomething() {
	    	 log.info("This is from CommonMethods");
	     }
	     /**
	      * @author Bayramgul
	     ...
	     * @return method will return RequestSpecification type request
	      */
	     	public static RequestSpecification headersInRequest() {
	     		RequestSpecification request =given().header("Content-Type","application/json").header("Authorization",SyntaxAPIAuthenticationSteps.Token);
	     	return request;
	     	}
}