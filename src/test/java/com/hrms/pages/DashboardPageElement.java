...
public class DashboardPageElement extends CommonMethods {
	...
	private static DashboardPageElement dashboardPageInstance; 
	
	private DashboardPageElement() {
		PageFactory.initElements(BaseClass.driver,this);
	}
	
	public static DashboardPageElement getInstance() {
		if (dashboardPageInstance == null)
			dashboardPageInstance = new DashboardPageElement();
