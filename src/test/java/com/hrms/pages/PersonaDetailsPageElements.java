...
public class PersonaDetailsPageElements {
	...
	private static PersonaDetailsPageElements personalDetailInstance; 
	
	private PersonaDetailsPageElements() {
		PageFactory.initElements(BaseClass.driver, this);
	}
	
	public static PersonaDetailsPageElements getInstance() {
		if (personalDetailInstance == null) 
			personalDetailInstance = new PersonaDetailsPageElements();
		return personalDetailInstance;
	}
